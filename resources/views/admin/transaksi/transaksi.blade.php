                                    ...
                                    <form action="{{ action('TransaksiController@store') }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="addtgl_pinjam" id="addtgl_pinjam" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="addtgl_kembali">Tanggal Kembali</label>
                                                <input type="date" name="addtgl_kembali" id="addtgl_kembali" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select name="addkd_buku" id="addkd_buku" class="form-control" required>
                                                    ...
                                                    @foreach ($buku as $item)
                                                        @if ($item != null)
                                                        <option value="{{ $item->kd_buku }}">{{ $item->kd_buku }} - {{ $item->judul }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
